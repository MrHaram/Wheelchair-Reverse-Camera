...
def updateSelection1():
    ...
    while True:   
        ...
        startProgram = Button(self, text = "Start", font = "Arial", command = goFeedScreen, padx = 50, pady = 50, fg = "black", bg = "yellow", bd = 10, relief = relief1).place(relx = 0.25, rely = 0.5, anchor = CENTER)
        exitProgram = Button(self, text = "Exit", font = "Arial", command = sys.exit, padx = 50, pady = 50, fg = "black", bg = "yellow", bd = 10, relief = relief2).place(relx = 0.75, rely = 0.5, anchor = CENTER)
